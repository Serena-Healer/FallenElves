...
public abstract class CommonProxy {
    ...
    public void preinit(FMLPreInitializationEvent event) {
        ...
        System.out.println(Confiance5th.MOD_NAME + " : PreInit took: " + (System.nanoTime() - startTime) + "ms.");
    }
    ...
    public void init(FMLInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(Confiance5th.INSTANCE, new GuiHandler());
        ...
        System.out.println(Confiance5th.MOD_NAME + " : Init took: " + (System.nanoTime() - startTime) + "ms.");
    }
