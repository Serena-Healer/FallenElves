...
import scellena.fallen_elves.spells.types.TestSpell;
...
public class SpellRegistry {
    ...
    public static void init(){
        ...
        SPELLS.register(new SpellRegistryEntry(TestSpell.class, new ResourceLocation(FallenElves.MOD_ID, "test")));
