...
public class SuperFlatGenerator implements IChunkGenerator {
    ...
    public SuperFlatGenerator(World worldIn, long seed, boolean generateStructures, String flatGeneratorSettings)
    {
        this.world = worldIn;
